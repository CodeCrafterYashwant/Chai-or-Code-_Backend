...
const addComment = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(
        new ApiResponse(201,comment,'Comment Succesfully added.')
    )
});
...
const updateComment = asyncHandler(async (req, res) => {
    ...
    if(!updatedComment){
        throw new ApiError(403,'Either comment not exist or you are not owner of this comment')
    }
    return res.status(200).json(
...
const deleteComment = asyncHandler(async (req, res) => {
    ...
    if(!deletedComment){
        throw new ApiError(403,'You are not owner of this comment or comment not exist')
    }    
    return res.status(200).json(
